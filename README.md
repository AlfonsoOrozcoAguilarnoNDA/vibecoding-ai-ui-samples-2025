...
Es importante aclarar que en este repositorio no se encontrarán artefactos de Mistral, Gemini o incluso Claude, no porque estas herramientas no hayan sido útiles, sino porque el material aquí presentado representa principalmente las soluciones de Cohere y Gemini que fueron refinadas y consolidadas. Además, durante el proceso de rediseño en julio de 2025, determiné que en varias pantallas el requisito del perfil lateral ya no era necesario, por lo que en algunos casos fue eliminado completamente de la interfaz, simplificando aún más la experiencia de usuario.
